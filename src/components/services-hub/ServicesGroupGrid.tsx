    ...
    services: [
      {
        id: 'yandex-direct',
        title: 'Яндекс Директ',
        problemSolved: 'Привлекает горячий поисковый спрос и помогает масштабировать привлечение при контролируемой экономике.',
    ...
    services: [
      {
        ...
        problemSolved: 'Квалифицирует заявки без задержек и выполняет рутинные рабочие сценарии.',
      ...
      },
      {
        id: 'crm',
        title: 'Внедрение CRM',
        problemSolved: 'Снижает риск потери входящих обращений и автоматизирует контроль сделок.',
    ...
    services: [
      {
        ...
        deliverables: ['Разработка парсеров под доступные сайты и каталоги', 'Очистка и нормализация потока данных', 'Telegram-алерты об изменении цен'],
      ...
      },
      {
        ...
        problemSolved: 'Показывает реальную окупаемость рекламы от клика до сделки.',
        deliverables: ['Связка рекламных каналов с CRM и кассой', 'Построение дашбордов окупаемости и CPL', 'Настройка корректной передачи UTM-меток'],
