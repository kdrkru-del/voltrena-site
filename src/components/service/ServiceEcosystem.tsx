...
export default function ServiceEcosystem({ items }: ServiceEcosystemProps) {
    ...
    return (
      <section className="py-section bg-bg-primary relative overflow-hidden">
        <div className="container mx-auto px-4">
          <SectionHeading title="Сайт может работать гораздо больше." align="center" />
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="relative w-full max-w-2xl mx-auto h-[500px] mt-12">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-24 rounded-full bg-bg-surface border border-accent/40 flex items-center justify-center shadow-[0_0_15px_rgba(99,102,241,0.2)]">
            <span className="font-mono text-sm text-accent animate-pulse">САЙТ</span>
          </div>
